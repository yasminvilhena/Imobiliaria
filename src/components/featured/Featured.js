    ...
    return (
        <div className='featured'>
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        <h2>123 Av. Lúcio Costa, Barra da Tijuca</h2>
                        <p>Valor</p>
                        <p className='price'>R$3,677,000</p>
                    </div>
                    <div className='info-grid'>
                        ...
                        <div>
                            <div className='info'>
                                <p className='bold'>Metros:</p><p>2,4 milhões M²</p>
                            </div>
                            <div className='info'>
                                <p className='bold'>Aluguel:</p><p>R$14.797</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className='container'>
                ...
                <div className='span-3 img-details order-6'>
                    <div className='top'>
                        <h2>124 Av.Niemeyer, Leblon </h2>
                        <p>Valor</p>
                        <p className='price'>R$6,677,000</p>
                    </div>
                    <div className='info-grid'>
                        <div>
                            <div className='info'>
                        ...
                        <div>
                            <div className='info'>
                                <p className='bold'>Metros:</p><p>4,4 milhões de M²</p>
                            </div>
                            <div className='info'>
                                <p className='bold'>Aluguel:</p><p>$15.797,00</p>
                            </div>
                        </div>
                    </div>
                </div>
